...
function display_game_over() {
  ...
  ctx.fillStyle = 'red';
  ctx.textAlign = 'center';
  ctx.fillText('zjadłeś sałatkę :(', myCanvas.width / 2, 100);
  ctx.fillText('Score: ' + score, myCanvas.width / 2, 150);
  ctx.font = '20px Arial';
  ctx.fillText('press to play again', myCanvas.width / 2, 300);
}
...
var bird = new MySprite('prezes.png');
